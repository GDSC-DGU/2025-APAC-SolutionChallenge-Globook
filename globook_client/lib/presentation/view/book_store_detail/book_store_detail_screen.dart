        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              CategoryBooks(
                title: '${viewModel.currentBook!.author}의 다른 도서',
                books: viewModel.authorBooks,
                onViewAllPressed: viewModel.onViewAllAuthorBooks,
                onBookPressed: viewModel.onAuthorBookPressed,
              ),
            ],
          ),
        ),
